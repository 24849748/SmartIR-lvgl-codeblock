...
void start_page(void){
    ...
    // startPageBG = lv_obj_create(bg_screen);
    // lv_obj_remove_style_all(startPageBG);
    // lv_obj_set_size(startPageBG, 240, 320);
    // lv_obj_set_style_radius(startPageBG,2,0); //圆角设置
    // lv_obj_set_style_bg_opa(startPageBG,LV_OPA_COVER,0);
    // lv_obj_set_style_bg_color(startPageBG, BG_COLOR,0);
    // lv_obj_center(startPageBG);
